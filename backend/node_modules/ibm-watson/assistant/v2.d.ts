...
declare namespace AssistantV2 {
    ...
    namespace ListProvidersConstants {
    ...
    interface ListAssistantsParams {
        /** The number of records to return in each page of results. */
        pageLimit?: number;
        /** Whether to include information about the number of records that satisfy the request, regardless of the page
         *  limit. If this parameter is `true`, the `pagination` object in the response includes the `total` property.
    ...
    namespace ListAssistantsConstants {
    ...
    interface MessageStreamStatelessParams {
        /** The assistant ID or the environment ID of the environment where the assistant is deployed, depending on the
         *  type of request:
         *   - For message, session, and log requests, specify the environment ID of the environment where the assistant is
         *  deployed.
    ...
    namespace ListEnvironmentsConstants {
    ...
    namespace ListReleasesConstants {
    ...
    interface CreateReleaseExportParams {
        /** The assistant ID or the environment ID of the environment where the assistant is deployed, depending on the
         *  type of request:
         *   - For message, session, and log requests, specify the environment ID of the environment where the assistant is
         *  deployed.
    ...
    interface DownloadReleaseExportParams {
        /** The assistant ID or the environment ID of the environment where the assistant is deployed, depending on the
         *  type of request:
         *   - For message, session, and log requests, specify the environment ID of the environment where the assistant is
         *  deployed.
    ...
    interface DownloadReleaseExportAsStreamParams {
        /** The assistant ID or the environment ID of the environment where the assistant is deployed, depending on the
         *  type of request:
         *   - For message, session, and log requests, specify the environment ID of the environment where the assistant is
         *  deployed.
    ...
    interface CreateReleaseImportParams {
        /** The assistant ID or the environment ID of the environment where the assistant is deployed, depending on the
         *  type of request:
         *   - For message, session, and log requests, specify the environment ID of the environment where the assistant is
         *  deployed.
    ...
    interface GetReleaseImportStatusParams {
        /** The assistant ID or the environment ID of the environment where the assistant is deployed, depending on the
         *  type of request:
         *   - For message, session, and log requests, specify the environment ID of the environment where the assistant is
         *  deployed.
    ...
    interface ImportSkillsStatusParams {
        /** The assistant ID or the environment ID of the environment where the assistant is deployed, depending on the
         *  type of request:
         *   - For message, session, and log requests, specify the environment ID of the environment where the assistant is
         *  deployed.
     ...
     * The search skill orchestration settings for the environment.
     */
    interface BaseEnvironmentOrchestration {
     ...
     */
    interface BaseEnvironmentReleaseReference {
     ...
     * integration.
     */
    interface ChannelTransferTarget {
     ...
     * Information for transferring to the web chat integration.
     */
    interface ChannelTransferTargetChat {
     ...
     */
    interface CreateAssistantReleaseImportResponse {
    ...
    namespace CreateAssistantReleaseImportResponse {
        namespace Constants {
     ...
     */
    interface CreateReleaseExportWithStatusErrors {
    ...
    namespace CreateReleaseExportWithStatusErrors {
        namespace Constants {
    ...
    namespace EnvironmentReference {
        namespace Constants {
     ...
     */
    interface MessageContextActionSkill {
    ...
    namespace MessageContextGlobalSystem {
        namespace Constants {
     ...
     */
    interface MessageInputAttachment {
     ...
     */
    interface MessageOutputDebugTurnEvent {
    }
    /**
     * Properties describing any spelling corrections in the user input that was received.
     */
     ...
     */
    interface MonitorAssistantReleaseImportArtifactResponse {
    ...
    namespace MonitorAssistantReleaseImportArtifactResponse {
        namespace Constants {
     ...
     */
    interface ProviderAuthenticationOAuth2 {
    ...
    namespace ProviderAuthenticationOAuth2 {
        namespace Constants {
     ...
     * Scenarios performed by the API client to fetch an access token from the authorization server.
     */
    interface ProviderAuthenticationOAuth2Flows {
    }
    /**
     * The username for oauth2 authentication when the preferred flow is "password".
     */
    interface ProviderAuthenticationOAuth2PasswordUsername {
    ...
    namespace ProviderAuthenticationOAuth2PasswordUsername {
        namespace Constants {
            /** The type of property observed in "value". */
            enum Type {
                VALUE = "value"
     ...
     */
    interface ProviderAuthenticationTypeAndValue {
        /** The type of property observed in "value". */
        type?: ProviderAuthenticationTypeAndValue.Constants.Type | string;
        /** The stored information of the value. */
        value?: string;
    }
    namespace ProviderAuthenticationTypeAndValue {
        namespace Constants {
            /** The type of property observed in "value". */
            enum Type {
                VALUE = "value"
     ...
     * Private authentication information of the provider.
     */
    interface ProviderPrivateAuthentication {
    }
    /**
     * Scenarios performed by the API client to fetch an access token from the authorization server.
     */
    interface ProviderPrivateAuthenticationOAuth2FlowFlows {
    }
    /**
     * The password for oauth2 authentication when the preferred flow is "password".
     */
    interface ProviderPrivateAuthenticationOAuth2PasswordPassword {
        /** The type of property observed in "value". */
        type?: ProviderPrivateAuthenticationOAuth2PasswordPassword.Constants.Type | string;
        /** The stored information of the value. */
        value?: string;
    }
    namespace ProviderPrivateAuthenticationOAuth2PasswordPassword {
        namespace Constants {
            /** The type of property observed in "value". */
            enum Type {
                VALUE = "value"
     ...
     * The specification of the provider.
     */
    interface ProviderResponseSpecification {
     ...
     * An object defining various reusable definitions of the provider.
     */
    interface ProviderResponseSpecificationComponents {
     ...
     * The definition of the security scheme for the provider.
     */
    interface ProviderResponseSpecificationComponentsSecuritySchemes {
    ...
    namespace ProviderResponseSpecificationComponentsSecuritySchemes {
        namespace Constants {
     ...
     * Non-private settings for basic access authentication.
     */
    interface ProviderResponseSpecificationComponentsSecuritySchemesBasic {
     ...
     */
    interface ProviderResponseSpecificationServersItem {
     ...
     * An object defining various reusable definitions of the provider.
     */
    interface ProviderSpecificationComponents {
        /** The definition of the security scheme for the provider. */
     ...
     * The definition of the security scheme for the provider.
     */
    interface ProviderSpecificationComponentsSecuritySchemes {
        /** The authentication method required for requests made from watsonx Assistant to the conversational skill
         *  provider.
         */
    ...
    namespace ProviderSpecificationComponentsSecuritySchemes {
        namespace Constants {
            /** The authentication method required for requests made from watsonx Assistant to the conversational skill provider. */
            enum AuthenticationMethod {
                BASIC = "basic",
     ...
     * Non-private settings for basic access authentication.
     */
    interface ProviderSpecificationComponentsSecuritySchemesBasic {
        /** The username for basic access authentication. */
        username?: ProviderAuthenticationTypeAndValue;
    }
    /**
     ...
     */
    interface ProviderSpecificationServersItem {
        /** The URL of the conversational skill provider. */
        url?: string;
    }
    /**
     ...
     */
    interface ResponseGenericChannel {
    ...
    namespace RuntimeEntityInterpretation {
        namespace Constants {
            /** The precision or duration of a time range specified by a recognized `@sys-time` or `@sys-date` entity. */
            enum Granularity {
                DAY = "day",
     ...
     * integration.
     */
    interface SearchSettingsClientSideSearch {
     ...
     * Configuration settings for conversational search.
     */
    interface SearchSettingsConversationalSearch {
     ...
     */
    interface SearchSettingsConversationalSearchResponseLength {
    ...
    namespace SearchSettingsConversationalSearchResponseLength {
        namespace Constants {
            /** The response length option. It controls the length of the generated response. */
            enum Option {
                CONCISE = "concise",
     ...
     */
    interface SearchSettingsConversationalSearchSearchConfidence {
    ...
    namespace SearchSettingsConversationalSearchSearchConfidence {
        namespace Constants {
     ...
     * Configuration settings for the Watson Discovery service instance used by the search integration.
     */
    interface SearchSettingsDiscovery {
     ...
     *  **Note:** You must specify either **basic** or **bearer**, but not both.
     */
    interface SearchSettingsDiscoveryAuthentication {
     ...
     * auth or apiKey auth.
     */
    interface SearchSettingsElasticSearch {
     ...
     * The messages included with responses from the search integration.
     */
    interface SearchSettingsMessages {
     ...
     * The mapping between fields in the Watson Discovery collection and properties in the search response.
     */
    interface SearchSettingsSchemaMapping {
     ...
     */
    interface SearchSettingsServerSideSearch {
    ...
    namespace SearchSettingsServerSideSearch {
        namespace Constants {
            /** The authorization type that is used. */
            enum AuthType {
                BASIC = "basic",
     ...
     */
    interface SkillsAsyncRequestStatus {
    ...
    namespace SkillsAsyncRequestStatus {
        namespace Constants {
     ...
     * A response from the watsonx Assistant service.
     */
    interface StatefulMessageResponse {
        /** Assistant output to be rendered or processed by the client. */
     ...
     */
    interface StatelessMessageContext {
        /** Session context data that is shared by all skills used by the assistant. */
     ...
     * Session context data that is shared by all skills used by the assistant.
     */
    interface StatelessMessageContextGlobal {
        /** Built-in system properties that apply to all skills used by the assistant. */
        system?: MessageContextGlobalSystem;
     ...
     * Context data specific to particular skills used by the assistant.
     */
    interface StatelessMessageContextSkills {
        /** Context variables that are used by the dialog skill. */
        'main skill'?: MessageContextDialogSkill;
     ...
     * Context variables that are used by the action skill.
     */
    interface StatelessMessageContextSkillsActionsSkill {
        /** An object containing any arbitrary variables that can be read and written by a particular skill. */
        user_defined?: JsonObject;
        /** System context data used by the skill. */
        system?: MessageContextSkillSystem;
     ...
     * An input object that includes the input text.
     */
    interface StatelessMessageInput {
        /** The type of the message:
         *
         *  - `text`: The user input is processed normally by the assistant.
         *  - `search`: Only search results are returned. (Any dialog or action skill is bypassed.)
    ...
    namespace StatelessMessageInput {
        namespace Constants {
            /** The type of the message: - `text`: The user input is processed normally by the assistant. - `search`: Only search results are returned. (Any dialog or action skill is bypassed.) **Note:** A `search` message results in an error if no search skill is configured for the assistant. */
            enum MessageType {
                TEXT = "text",
     ...
     * Optional properties that control how the assistant responds.
     */
    interface StatelessMessageInputOptions {
        /** Whether to restart dialog processing at the root of the dialog, regardless of any previously visited nodes.
         *  **Note:** This does not affect `turn_count` or any other context variables.
         */
        restart?: boolean;
     ...
     */
    interface StatelessMessageResponse {
        /** Assistant output to be rendered or processed by the client. */
        output: MessageOutput;
     ...
     */
    interface TurnEventActionSource {
    ...
    namespace TurnEventActionSource {
        namespace Constants {
            /** The type of turn event. */
            enum Type {
                ACTION = "action"
     ...
     */
    interface TurnEventCalloutCallout {
    ...
    namespace TurnEventCalloutCallout {
        namespace Constants {
     ...
     */
    interface TurnEventCalloutCalloutRequest {
    ...
    namespace TurnEventCalloutCalloutRequest {
        namespace Constants {
            /** The REST method of the request. */
            enum Method {
                GET = "get",
     ...
     */
    interface TurnEventCalloutCalloutResponse {
     ...
     */
    interface TurnEventCalloutError {
     ...
     */
    interface TurnEventSearchError {
     ...
     * The search skill orchestration settings for the environment.
     */
    interface UpdateEnvironmentOrchestration {
        /** Whether to fall back to a search skill when responding to messages that do not match any intent or action
         *  defined in dialog or action skills. (If no search skill is configured for the environment, this property is
         *  ignored.).
         */
     ...
     * An object describing the release that is currently deployed in the environment.
     */
    interface UpdateEnvironmentReleaseReference {
        /** The name of the deployed release. */
        release?: string;
    }
    /**
     * CompleteItem.
     */
    interface CompleteItem extends RuntimeResponseGeneric {
        streaming_metadata: Metadata;
    }
    /**
     * An object that identifies the dialog element that generated the error message.
     */
    interface LogMessageSourceAction extends LogMessageSource {
     ...
     * An object that identifies the dialog element that generated the error message.
     */
    interface LogMessageSourceDialogNode extends LogMessageSource {
        /** A string that indicates the type of dialog element that generated the error message. */
        type: string;
     ...
     * An object that identifies the dialog element that generated the error message.
     */
    interface LogMessageSourceHandler extends LogMessageSource {
        /** A string that indicates the type of dialog element that generated the error message. */
        type: string;
        /** The unique identifier of the action that generated the error message. */
        action: string;
     ...
     * An object that identifies the dialog element that generated the error message.
     */
    interface LogMessageSourceStep extends LogMessageSource {
        /** A string that indicates the type of dialog element that generated the error message. */
        type: string;
        /** The unique identifier of the action that generated the error message. */
        action: string;
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventActionFinished extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
    ...
    namespace MessageOutputDebugTurnEventTurnEventActionFinished {
        namespace Constants {
            /** The type of condition (if any) that is defined for the action. */
            enum ConditionType {
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventActionVisited extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
        source?: TurnEventActionSource;
        /** The time when the action started processing the message. */
    ...
    namespace MessageOutputDebugTurnEventTurnEventActionVisited {
        namespace Constants {
            /** The type of condition (if any) that is defined for the action. */
            enum ConditionType {
                USER_DEFINED = "user_defined",
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventCallout extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
        source?: TurnEventActionSource;
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventHandlerVisited extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
        source?: TurnEventActionSource;
        /** The time when the action started processing the message. */
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventNodeVisited extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
    ...
    namespace MessageOutputDebugTurnEventTurnEventNodeVisited {
        namespace Constants {
            /** The reason the dialog node was visited. */
            enum Reason {
                WELCOME = "welcome",
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventSearch extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
        source?: TurnEventActionSource;
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventStepAnswered extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
        source?: TurnEventActionSource;
        /** The type of condition (if any) that is defined for the action. */
    ...
    namespace MessageOutputDebugTurnEventTurnEventStepAnswered {
        namespace Constants {
            /** The type of condition (if any) that is defined for the action. */
            enum ConditionType {
                USER_DEFINED = "user_defined",
     ...
     */
    interface MessageOutputDebugTurnEventTurnEventStepVisited extends MessageOutputDebugTurnEvent {
        /** The type of turn event. */
        event?: string;
        source?: TurnEventActionSource;
        /** The type of condition (if any) that is defined for the action. */
    ...
    namespace MessageOutputDebugTurnEventTurnEventStepVisited {
        namespace Constants {
            /** The type of condition (if any) that is defined for the action. */
            enum ConditionType {
                USER_DEFINED = "user_defined",
     ...
     */
    interface ProviderAuthenticationOAuth2FlowsProviderAuthenticationOAuth2AuthorizationCode extends ProviderAuthenticationOAuth2Flows {
        /** The token URL. */
        token_url?: string;
    ...
    namespace ProviderAuthenticationOAuth2FlowsProviderAuthenticationOAuth2AuthorizationCode {
        namespace Constants {
            /** The client authorization type. */
            enum ClientAuthType {
                BODY = "Body",
     ...
     */
    interface ProviderAuthenticationOAuth2FlowsProviderAuthenticationOAuth2ClientCredentials extends ProviderAuthenticationOAuth2Flows {
        /** The token URL. */
        token_url?: string;
        /** The refresh token URL. */
        refresh_url?: string;
    ...
    namespace ProviderAuthenticationOAuth2FlowsProviderAuthenticationOAuth2ClientCredentials {
        namespace Constants {
            /** The client authorization type. */
            enum ClientAuthType {
                BODY = "Body",
     ...
     */
    interface ProviderAuthenticationOAuth2FlowsProviderAuthenticationOAuth2Password extends ProviderAuthenticationOAuth2Flows {
        /** The token URL. */
        token_url?: string;
        /** The refresh token URL. */
        refresh_url?: string;
    ...
    namespace ProviderAuthenticationOAuth2FlowsProviderAuthenticationOAuth2Password {
        namespace Constants {
            /** The client authorization type. */
            enum ClientAuthType {
                BODY = "Body",
     ...
     */
    interface ProviderPrivateAuthenticationBasicFlow extends ProviderPrivateAuthentication {
     ...
     */
    interface ProviderPrivateAuthenticationBearerFlow extends ProviderPrivateAuthentication {
     ...
     */
    interface ProviderPrivateAuthenticationOAuth2Flow extends ProviderPrivateAuthentication {
        /** Scenarios performed by the API client to fetch an access token from the authorization server. */
     ...
     */
    interface ProviderPrivateAuthenticationOAuth2FlowFlowsProviderPrivateAuthenticationOAuth2AuthorizationCode extends ProviderPrivateAuthenticationOAuth2FlowFlows {
        /** The client ID. */
        client_id?: string;
        /** The client secret. */
     ...
     */
    interface ProviderPrivateAuthenticationOAuth2FlowFlowsProviderPrivateAuthenticationOAuth2ClientCredentials extends ProviderPrivateAuthenticationOAuth2FlowFlows {
        /** The client ID. */
        client_id?: string;
        /** The client secret. */
        client_secret?: string;
     ...
     */
    interface ProviderPrivateAuthenticationOAuth2FlowFlowsProviderPrivateAuthenticationOAuth2Password extends ProviderPrivateAuthenticationOAuth2FlowFlows {
        /** The client ID. */
        client_id?: string;
        /** The client secret. */
        client_secret?: string;
     ...
     */
    interface RuntimeResponseGenericRuntimeResponseTypeAudio extends RuntimeResponseGeneric {
     ...
     */
    interface RuntimeResponseGenericRuntimeResponseTypeChannelTransfer extends RuntimeResponseGeneric {
        /** The type of response returned by the dialog node. The specified response type must be supported by the
         *  client application or channel.
         *
     ...
     */
    interface RuntimeResponseGenericRuntimeResponseTypeDate extends RuntimeResponseGeneric {
        /** The type of response returned by the dialog node. The specified response type must be supported by the
         *  client application or channel.
         */
        response_type: string;
     ...
     */
    interface RuntimeResponseGenericRuntimeResponseTypeIframe extends RuntimeResponseGeneric {
        /** The type of response returned by the dialog node. The specified response type must be supported by the
         *  client application or channel.
         */
        response_type: string;
    ...
    namespace RuntimeResponseGenericRuntimeResponseTypeOption {
        namespace Constants {
            /** The preferred type of control to display. */
            enum Preference {
                DROPDOWN = "dropdown",
     ...
     */
    interface RuntimeResponseGenericRuntimeResponseTypeUserDefined extends RuntimeResponseGeneric {
        /** The type of response returned by the dialog node. The specified response type must be supported by the
         *  client application or channel.
         */
        response_type: string;
     ...
     */
    interface RuntimeResponseGenericRuntimeResponseTypeVideo extends RuntimeResponseGeneric {
        /** The type of response returned by the dialog node. The specified response type must be supported by the
         *  client application or channel.
         */
        response_type: string;
