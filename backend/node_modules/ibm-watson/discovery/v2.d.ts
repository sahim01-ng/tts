...
declare class DiscoveryV2 extends BaseService {
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>}
     */
    deleteTrainingQuery(params: DiscoveryV2.DeleteTrainingQueryParams): Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>;
    /*************************
     * enrichments
     ************************/
    /**
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>}
     */
    deleteEnrichment(params: DiscoveryV2.DeleteEnrichmentParams): Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>;
    /*************************
     * batches
     ************************/
    /**
     ...
     */
    listBatches(params: DiscoveryV2.ListBatchesParams): Promise<DiscoveryV2.Response<DiscoveryV2.ListBatchesResponse>>;
    /**
     * Pull batches.
     *
     ...
     */
    pullBatches(params: DiscoveryV2.PullBatchesParams): Promise<DiscoveryV2.Response<DiscoveryV2.PullBatchesResponse>>;
    /**
     * Push batches.
     *
     ...
     */
    pushBatches(params: DiscoveryV2.PushBatchesParams): Promise<DiscoveryV2.Response<boolean>>;
    /*************************
     * documentClassifiers
     ************************/
    /**
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>}
     */
    deleteDocumentClassifier(params: DiscoveryV2.DeleteDocumentClassifierParams): Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>;
    /*************************
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>}
     */
    deleteDocumentClassifierModel(params: DiscoveryV2.DeleteDocumentClassifierModelParams): Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>;
    /*************************
     * analyze
     ************************/
    /**
     ...
     * @returns {Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>}
     */
    deleteUserData(params: DiscoveryV2.DeleteUserDataParams): Promise<DiscoveryV2.Response<DiscoveryV2.EmptyObject>>;
}
/*************************
 * interfaces
 ************************/
declare namespace DiscoveryV2 {
    ...
    namespace CollectionDetailsSmartDocumentUnderstanding {
        namespace Constants {
    ...
    namespace ComponentSettingsAggregation {
        namespace Constants {
            /** Type of visualization to use when rendering the aggregation. */
    ...
    namespace DeleteDocumentResponse {
        namespace Constants {
            /** Status of the document. A deleted document has the status deleted. */
            enum Status {
                DELETED = "deleted"
    ...
    namespace DocumentClassifierModel {
        namespace Constants {
            /** The status of the training run. */
            enum Status {
                TRAINING = "training",
     ...
     */
    interface QueryPairAggregationResult {
    ...
    namespace QueryResultMetadata {
        namespace Constants {
            /** The document retrieval source that produced this search result. */
            enum DocumentRetrievalSource {
                SEARCH = "search",
                CURATION = "curation"
            }
        }
     ...
     */
    interface QueryTopicAggregationResult {
     ...
     */
    interface QueryTrendAggregationResult {
        /** Array of subaggregations of type `term` or `group_by` and `timeslice`. Each element of the matrix that is
    ...
    namespace RetrievalDetails {
        namespace Constants {
            ...
            enum DocumentRetrievalStrategy {
                UNTRAINED = "untrained",
     ...
     */
    interface QueryAggregationQueryCalculationAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryFilterAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryGroupByAggregation extends QueryAggregation {
     ...
     * category.
     */
    interface QueryAggregationQueryHistogramAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryNestedAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryPairAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryTermAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryTimesliceAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryTopHitsAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryTopicAggregation extends QueryAggregation {
     ...
     */
    interface QueryAggregationQueryTrendAggregation extends QueryAggregation {
